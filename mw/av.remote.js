...
(function() {
	...
	var eq = [
		...
		{title: 'Щит [Ультра]', name: 'antigranata', image: '<img src="http://www.gopiki.ru/img/eq/4.jpg" style="width: 16px; height: 16px; vertical-align: middle;">'},
		...
		{title: 'Тыква «Колхозная»', name: 'tikva', image: '<img src="http://www.gopiki.ru/img/eq/22.jpg" style="width: 16px; height: 16px; vertical-align: middle;">'},
		{title: 'Орех «Кокосовый»', name: 'oreh', image: '<img src="http://www.gopiki.ru/img/eq/21.jpg" style="width: 16px; height: 16px; vertical-align: middle;">'},
		{title: 'Роллы «Огурцовые» [Ультра]', name: 'rolls_ultra', image: '<img src="http://www.gopiki.ru/img/eq/13.jpg" style="width: 16px; height: 16px; vertical-align: middle;">'},
		{title: 'Роллы «Огурцовые» [Мега]', name: 'rolls_mega', image: '<img src="http://www.gopiki.ru/img/eq/13.jpg" style="width: 16px; height: 16px; vertical-align: middle;">'},
		{title: 'Роллы «Огурцовые»', name: 'rolls', image: '<img src="http://www.gopiki.ru/img/eq/13.jpg" style="width: 16px; height: 16px; vertical-align: middle;">'},
		{title: 'Гранат «Осколочный»', name: 'granat', image: '<img src="http://www.gopiki.ru/img/eq/24.jpg" style="width: 16px; height: 16px; vertical-align: middle;">'},
		{title: 'Дуриан «Заморский»', name: 'durian', image: '<img src="http://www.gopiki.ru/img/eq/23.jpg" style="width: 16px; height: 16px; vertical-align: middle;">'},
		{title: 'Вкусный воккер', name: 'vokker', image: '<img src="http://www.gopiki.ru/img/eq/16.jpg" style="width: 16px; height: 16px; vertical-align: middle;">'},
		{title: 'Вкусный воккер [Ультра]', name: 'vokker', image: '<img src="http://www.gopiki.ru/img/eq/15.jpg" style="width: 16px; height: 16px; vertical-align: middle;">'},
		{title: 'Икорка на черством хлебушке', name: 'ikorka', image: '<img src="http://www.gopiki.ru/img/eq/12.jpg" style="width: 16px; height: 16px; vertical-align: middle;">'},
		{title: 'Кластерная граната', name: 'klaster', image: '<img src="http://www.gopiki.ru/img/eq/10.jpg" style="width: 16px; height: 16px; vertical-align: middle;">'},
		{title: 'Кластерная граната [Ультра]', name: 'klaster_ultra', image: '<img src="http://www.gopiki.ru/img/eq/9.jpg" style="width: 16px; height: 16px; vertical-align: middle;">'},
		{title: 'Кластерная граната [Мега]', name: 'klaster_mega', image: '<img src="http://www.gopiki.ru/img/eq/9.jpg" style="width: 16px; height: 16px; vertical-align: middle;">'},
		{title: 'Коктейль Молотова', name: 'molotov', image: '<img src="http://www.gopiki.ru/img/eq/7.jpg" style="width: 16px; height: 16px; vertical-align: middle;">'},
		{title: 'Коктейль Молотова [Ультра]', name: 'molotov_ultra', image: '<img src="http://www.gopiki.ru/img/eq/8.jpg" style="width: 16px; height: 16px; vertical-align: middle;">'},
