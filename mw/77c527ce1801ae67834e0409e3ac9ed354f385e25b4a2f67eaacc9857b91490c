...
(function() {
	...
	var eq = [
		...
		{title: 'Щит [Ультра]', name: 'antigranata', image: '<img src="http://inteist.com/mw/img/eq/4.jpg" style="width: 16px; height: 16px; vertical-align: middle;">'},
		...
		{title: 'Тыква «Колхозная»', name: 'tikva', image: '<img src="http://inteist.com/mw/img/eq/22.jpg" style="width: 16px; height: 16px; vertical-align: middle;">'},
		{title: 'Орех «Кокосовый»', name: 'oreh', image: '<img src="http://inteist.com/mw/img/eq/21.jpg" style="width: 16px; height: 16px; vertical-align: middle;">'},
		{title: 'Роллы «Огурцовые» [Ультра]', name: 'rolls_ultra', image: '<img src="http://inteist.com/mw/img/eq/13.jpg" style="width: 16px; height: 16px; vertical-align: middle;">'},
		{title: 'Роллы «Огурцовые» [Мега]', name: 'rolls_mega', image: '<img src="http://inteist.com/mw/img/eq/13.jpg" style="width: 16px; height: 16px; vertical-align: middle;">'},
		{title: 'Роллы «Огурцовые»', name: 'rolls', image: '<img src="http://inteist.com/mw/img/eq/13.jpg" style="width: 16px; height: 16px; vertical-align: middle;">'},
		{title: 'Гранат «Осколочный»', name: 'granat', image: '<img src="http://inteist.com/mw/img/eq/24.jpg" style="width: 16px; height: 16px; vertical-align: middle;">'},
		{title: 'Дуриан «Заморский»', name: 'durian', image: '<img src="http://inteist.com/mw/img/eq/23.jpg" style="width: 16px; height: 16px; vertical-align: middle;">'},
		{title: 'Вкусный воккер', name: 'vokker', image: '<img src="http://inteist.com/mw/img/eq/16.jpg" style="width: 16px; height: 16px; vertical-align: middle;">'},
		{title: 'Вкусный воккер [Ультра]', name: 'vokker', image: '<img src="http://inteist.com/mw/img/eq/15.jpg" style="width: 16px; height: 16px; vertical-align: middle;">'},
		{title: 'Икорка на черством хлебушке', name: 'ikorka', image: '<img src="http://inteist.com/mw/img/eq/12.jpg" style="width: 16px; height: 16px; vertical-align: middle;">'},
		{title: 'Кластерная граната', name: 'klaster', image: '<img src="http://inteist.com/mw/img/eq/10.jpg" style="width: 16px; height: 16px; vertical-align: middle;">'},
		{title: 'Кластерная граната [Ультра]', name: 'klaster_ultra', image: '<img src="http://inteist.com/mw/img/eq/9.jpg" style="width: 16px; height: 16px; vertical-align: middle;">'},
		{title: 'Кластерная граната [Мега]', name: 'klaster_mega', image: '<img src="http://inteist.com/mw/img/eq/9.jpg" style="width: 16px; height: 16px; vertical-align: middle;">'},
		{title: 'Коктейль Молотова', name: 'molotov', image: '<img src="http://inteist.com/mw/img/eq/7.jpg" style="width: 16px; height: 16px; vertical-align: middle;">'},
		{title: 'Коктейль Молотова [Ультра]', name: 'molotov_ultra', image: '<img src="http://inteist.com/mw/img/eq/8.jpg" style="width: 16px; height: 16px; vertical-align: middle;">'},
...
function MultiOpenItem(item) {
	...
	showConfirm('<p align="center">Количество: <input id="multbuy" value="'+$(item).parent().find('.count').text().replace(/#/gi,'')+'"></p>', b, {"__title": "Открыть сразу"});
}
function ParseDataItem(data, st) {
	...
	for (var i in a.inventory) {
		if ('/@/images/obj/'+a.inventory[i].image == st) {
			return {id: a.inventory[i].id, alerts: al};
		}
	}
	return {alerts: al};
}
	...
	if (location.href.search(/[/]job[/]/) != -1) {
		if ($("#avaddon-avto-job-tonus").length == 0) {
			...
			$("#avaddon-avto-job-tonus").on("click", function() {
				...
				buttons.push({title: "Отмена", callback: null});
				showConfirm(html, buttons, {"__title": "Слить тонус"});
			});
		}
	}
});
...
function AvaddonBurnJobTonus(num, job) {
	...
	function AvaddonResetCooldown() {
		$.post("/alley/", {action: "rest_cooldown", code: 'tonus', ajax: true}, function(data) {
			if (data['result'] == 'ok') {
